...
base_dir = r'C:\Users\siwa\.gemini\antigravity\brain\cf8cea71-dda3-4bbf-bd13-ae805ca0bf8d'
out_file = r'f:\proyek service hp\Buku_Panduan_ServicePro_Lengkap.html'

files_to_merge = [
    ('docs_owner.md', 'Buku Panduan Owner'),
    ('docs_karyawan.md', 'Buku Panduan Karyawan'),
    ('blueprint_sistem.md', 'Blueprint Arsitektur Sistem')
]

md_content = '# 📖 BUKU PANDUAN LENGKAP SERVICEPRO HP v5.1\n\n'
md_content += 'Dokumen ini adalah **Buku Panduan Resmi** dari A sampai Z untuk aplikasi ServicePro HP yang telah dibangun. Dokumen ini mencakup cara penggunaan, daftar fitur, hingga arsitektur teknis.\n\n---\n\n'
...
<head>
    <meta charset="utf-8">
    <title>Buku Panduan Lengkap ServicePro</title>
    <style>
        ...
        blockquote { border-left: 4px solid #3498db; padding-left: 15px; color: #555; background: #f4f9fd; padding: 15px; margin-left: 0; border-radius: 4px; }
...
try:
    ...
    print('HTML Manual Book generated successfully!')
